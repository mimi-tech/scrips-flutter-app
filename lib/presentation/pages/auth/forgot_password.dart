                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                key: const ValueKey(Keys.verifyEmailText),
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                  key: const ValueKey(Keys.verifyEmailBtn),
                                  ...
                                  onPressed: (state is AuthLoading)? () => {null} :  () => {
                                    if(validateForm()){
                                      BlocProvider.of<AuthBloc>(context).add(AuthVerifyEmailRequested(emailController.text))
                                    }
                                  },
