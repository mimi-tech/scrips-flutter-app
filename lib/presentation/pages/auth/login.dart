                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 20.0, right: 40),
                                  child: TextFormField(
                                    key: const ValueKey(Keys.emailLoginField),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 20.0, right: 40),
                                  child: TextFormField(
                                    key: const ValueKey(Keys.passwordLoginField),
                                    style: const TextStyle(
                                        color: Colors.white,
                                        fontFamily: 'UniNeue',
                                        fontSize: 18),
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: (state is AuthLoading)? () => {null} :  () => {
                                                if(validateForm()){
                                                  BlocProvider.of<AuthBloc>(context).add(AuthLoginRequested(emailController.text, pwdController.text, "BlocLogin"))
                                                }
                                              },
                                ...
                                Center(
                                  child: GestureDetector(
                                    key: const Key(Keys.forgotPassword),
                                    onTap: () {
