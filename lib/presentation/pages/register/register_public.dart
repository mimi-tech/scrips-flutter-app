                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                key: const ValueKey(Keys.emailSignupKey),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                key: const ValueKey(Keys.passwordSignupKey),
                                style: const TextStyle(
                                    color: Colors.white, fontFamily: 'UniNeue'),
                            ...
                            Padding(
                              padding: const EdgeInsets.only(
                                  top: 40, left: 20.0, right: 40),
                              child: TextFormField(
                                key: const ValueKey(Keys.cPasswordSignupKey),
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontFamily: 'UniNeue',
                                    fontSize: 18),
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                key: const ValueKey(Keys.signupBtn),
                                  ...
                                  onPressed: (state is AuthLoading)? () => {null} :  () => {
                                    if(validateForm()){
                                      BlocProvider.of<AuthBloc>(context).add(AuthRegisterRequested(emailController.text, pwdController.text, "BlocLogin"))
                                    }
                                  },
